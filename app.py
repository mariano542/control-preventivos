...
def check_password():
    ...
    <style>
        ...
        #MainMenu,header,footer,[data-testid="stToolbar"],[data-testid="stDecoration"],[data-testid="stStatusWidget"],.stDeployButton,[data-testid="collapsedControl"]{display:none!important;}
        .stApp{background:#111111!important;}
        .login-box{background:#1E1E1E;border:1px solid #2A2A2A;border-top:4px solid #C8102E;border-radius:12px;padding:40px 36px;max-width:420px;margin:80px auto 0 auto;text-align:center;}
        .login-titulo{font-family:'Barlow Condensed',sans-serif;font-size:2rem;font-weight:800;color:#C8102E;text-transform:uppercase;letter-spacing:3px;margin-bottom:4px;}
        .login-sub{font-family:'Inter',sans-serif;font-size:0.75rem;color:#555;letter-spacing:1px;text-transform:uppercase;margin-bottom:28px;}
        .stTextInput input{background:#111!important;color:#FFF!important;border-color:#333!important;border-radius:7px!important;text-align:center!important;font-size:1.1rem!important;letter-spacing:4px!important;}
        .stTextInput label{color:#777!important;font-size:0.72rem!important;text-transform:uppercase!important;letter-spacing:1px!important;text-align:center!important;}
        .stButton > button{background:#C8102E!important;color:white!important;border:none!important;border-radius:7px!important;font-family:'Barlow Condensed',sans-serif!important;font-size:1rem!important;font-weight:700!important;letter-spacing:2px!important;padding:12px!important;width:100%!important;text-transform:uppercase!important;margin-top:8px!important;}
        .stButton > button:hover{background:#a50d25!important;}
    </style>
    ...
    with col2:
        st.markdown("""
        <div class="login-box">
            <div class="login-titulo">A.PE.S.A.</div>
            <div class="login-sub">Control de Mantenimiento · Acceso Restringido</div>
        </div>
        """, unsafe_allow_html=True)
